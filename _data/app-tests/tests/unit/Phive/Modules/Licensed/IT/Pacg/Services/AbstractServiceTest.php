 ...
 */
class AbstractServiceTest extends Support
{
    /**
     * @var AbstractEntity
     */
    ...
    /**
     * AbstractServiceTest constructor.
     * @param null $name
     * @param array $data
    ...
    {
        $validation_mock = \Mockery::mock(Validation::class)->makePartial();
    ...
    {
        $validator_mock = \Mockery::mock(Validator::class)->makePartial();

...
class CJTTest extends TestPhiveBase
{
    ...
    public function shouldSelectVersionProperlyDataProvider(): array
    {
        return [
            [
                Info::VERSIONS[2]['xmlVersion'],
                Info::VERSIONS[2]['endDateTime']
            ],
            [
                Info::VERSIONS[3]['xmlVersion'],
                (new \DateTimeImmutable(Info::VERSIONS[2]['endDateTime']))->modify('+1 day')->format('Y-m-d')
            ],
        ];
    }

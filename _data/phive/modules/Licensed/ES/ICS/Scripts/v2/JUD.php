...
// Example
// php JUD.php '2023-10-02_00:00:00' '2023-10-02_23:59:59'
...
function collectDataAndPutIntoCsv(string $start, string $end, array $lic_settings): void
{
    ...
    fputcsv($fp, ['record_id', 'user_id', 'bet_amount', 'bets_rollback', 'win_amount', 'start_time', 'end_time', 'ip', 'equipment', 'uagent', 'time_limit', 'spend_limit']);
...
function validateInternalVersion ($internal_version){
    if($internal_version !== \ES\ICS\Reports\v2\JUD::getInternalVersion()){

 ...
 */
class SoftwareCriticalModuleListType extends PgdaEntity
{
    /**
     * @var SoftwareCriticalModuleType[]
     */
    ...
    protected function setSoftwareModules()
    {
        ...
        foreach ($software_modules as $key => $software_module) {
            $this->software_modules[$key] = (new SoftwareCriticalModuleType())->fill($software_module);
    ...
    public function getSoftwareModule(): array
    {
        ...
        foreach ($this->software_modules as $software_module) {
            if (! ($software_module instanceof SoftwareCriticalModuleType)) {
                throw new \Exception('Attributes Session item isn\'t a SoftwareCriticalModuleType object');
            }

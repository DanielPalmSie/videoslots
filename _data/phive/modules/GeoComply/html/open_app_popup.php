...
<div class="geo_comply">
    ...
    <div class="geo_comply__btn-section">
        <button class="geo_comply__download-btn geo_comply__btn-blue-color" id="geo_comply_open">
            <img src="/diamondbet/images/geocomply/download_icon.svg" />
            <span><?php et('open.app') ?></span>
        </button>
    </div>
    <div class="geo_comply__app_info"><?php et('geoguard.app.info') ?></div>
</div>

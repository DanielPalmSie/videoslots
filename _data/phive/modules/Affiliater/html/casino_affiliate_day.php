...
$stats = $aff->getCacheForAff('', $start_date, $end_date, $_REQUEST['group_by'], $_REQUEST['use_table'], array(), ciso(), $_REQUEST['only_real'], $_REQUEST['bonus_code']);
	...
	<td>
	  <table>
	    ...
	    <tr>
	      <td>Use table:</td>
	      <td>
		<?php dbSelect("use_table", array('users_daily_stats' => 'Daily user cache', 'affiliate_daily_stats' => "Daily affiliate cache", 'affiliate_daily_bcodestats' => "Daily affiliate bonus code stats"), $_REQUEST['use_table']) ?>
	      </td>
	    </tr>
	    <tr>

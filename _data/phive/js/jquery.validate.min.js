    ...
    c.extend(c.validator, {
      ...
      prototype: {
        ...
        check: function (a) {
          ...
          for(e in b) {
            ...
            try {
              if(typeof c.validator.methods[e] == 'function'){                
      ...
      methods: {
          ...
          c.ajax(c.extend(true, {
            ...
            success: function (h) {
              ...
              if(j) {
                ...
                i[b.name] = e.message = typeof h === "function" ? h(a) : h;
                f.showErrors(i)
            }
              e.valid = j;
              f.stopRequest(b, j)
        ...
        equalTo: function (a, b, d) {
          d = c(d).off(".validate-equalTo").on("blur.validate-equalTo", function () {
            c(b).valid()
        });
          return a == d.val()
      }

...
ko.bindingHandlers.wysiwyg = {
  ...
  standardOptions: {},
  fullOptions: {
    toolbar1: 'bold italic forecolor backcolor hr styleselect removeformat | link unlink | pastetext code replacers',
    ...
    plugins: ["link hr paste lists textcolor code replacers"],
  ...
  init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
    ...
    var options = {
      ...
      hidden_input: false,
      plugins: ["paste replacers"],
      toolbar1: "bold italic replacers",
      toolbar2: "",

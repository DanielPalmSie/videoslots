            ...
            <form id="bonus-type-form" method="post">
                ...
                <div class="col-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <input name="expire_time" id="expire_time" type="date" class="form-control" data-placeholder="Select date" value="{{ $bonusType->expire_time }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="num_days" class="form-control" value="{{ $bonusType->num_days }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="cost" class="form-control" value="{{ $bonusType->cost }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="reward" class="form-control" value="{{ $bonusType->reward }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="bonus_name" class="form-control" value="{{ $bonusType->bonus_name }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="deposit_limit" class="form-control" value="{{ $bonusType->deposit_limit }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="rake_percent" class="form-control" value="{{ $bonusType->rake_percent }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="bonus_code" class="form-control" value="{{ $bonusType->bonus_code }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="deposit_multiplier" class="form-control" value="{{ $bonusType->deposit_multiplier }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-4 col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="game_tags" class="form-control" value="{{ $bonusType->game_tags }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="game_percents" class="form-control" value="{{ $bonusType->game_percents }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="cash_percentage" class="form-control" value="{{ $bonusType->cash_percentage }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="max_payout" class="form-control" value="{{ $bonusType->max_payout }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="reload_code" class="form-control" value="{{ $bonusType->reload_code }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="excluded_countries" class="form-control" value="{{ $bonusType->excluded_countries }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="included_countries" class="form-control" value="{{ $bonusType->included_countries }}">
                    </div>

                    <div class="form-group">
                        <label for="fail_limit">Fail limit</label>
                        <span data-toggle="tooltip" title="Fail limit" class="badge bg-light-blue">?</span>
                        <input type="number" name="fail_limit" class="form-control" value="{{ $bonusType->fail_limit }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="deposit_amount" class="form-control" value="{{ $bonusType->deposit_amount }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="deposit_max_bet_percent" class="form-control" value="{{ $bonusType->deposit_max_bet_percent }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="bonus_max_bet_percent" class="form-control" value="{{ $bonusType->bonus_max_bet_percent }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="max_bet_amount" class="form-control" value="{{ $bonusType->max_bet_amount }}">
                    </div>
                </div>
                <div class="col-4 col-lg-4">
                    <div class="form-group">
                        <label for="loyalty_percent">Loyalty percent</label>
                        <span data-toggle="tooltip" title="Set to for instance 0.5 if you want the bonus to generate 50% of the wager turnover towards the normal Weekend Booster, result: X wager * 0.5 * 0.01 = actual Weekend Booster." class="badge bg-light-blue">?</span>
                        <input type="number" name="loyalty_percent" class="form-control" value="{{ $bonusType->loyalty_percent }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="top_up" class="form-control" value="{{ $bonusType->top_up }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="stagger_percent" class="form-control" value="{{ $bonusType->stagger_percent }}">
                    </div>
                    <div class="form-group">
                        <label for="ext_ids">Ext ids</label>
                        <span data-toggle="tooltip" title="External ids" class="badge bg-light-blue">?</span>
                        <input type="text" name="ext_ids" class="form-control" value="{{ $bonusType->ext_ids }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="deposit_threshold" class="form-control" value="{{ $bonusType->deposit_threshold }}">
                    </div>
                    <div class="form-group">
                        <label for="game_id">Game id</label>
                        <span data-toggle="tooltip" title="Game id" class="badge bg-light-blue">?</span>
                        <input type="text" name="game_id" class="form-control" value="{{ $bonusType->game_id }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span data-toggle="tooltip" title="" class="badge bg-light-blue">?</span>
                        <input type="number" name="frb_coins" class="form-control" value="{{ $bonusType->frb_coins }}">
                    </div>
                    <div class="form-group">
                        <label for="frb_denomination">FRB denomination</label>
                        <span data-toggle="tooltip" title="" class="badge bg-light-blue">?</span>
                        <input type="number" name="frb_denomination" class="form-control" value="{{ $bonusType->frb_denomination }}">
                    </div>
                    <div class="form-group">
                        <label for="frb_lines">FRB lines</label>
                        <span data-toggle="tooltip" title="" class="badge bg-light-blue">?</span>
                        <input type="number" name="frb_lines" class="form-control" value="{{ $bonusType->frb_lines }}">
                    </div>
                    <div class="form-group">
                        <label for="frb_cost">FRB cost</label>
                        <span data-toggle="tooltip" title="" class="badge bg-light-blue">?</span>
                        <input type="number" name="frb_cost" class="form-control" value="{{ $bonusType->frb_cost }}">
                    </div>
                </div>

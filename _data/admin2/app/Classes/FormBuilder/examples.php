...
$oFormBuilder = new FormBuilder($oValidate, $oCollection);
...
$oFormBuilder->createInput([
	'name' => 'send',
	'type' => elements_ElementInterface::TYPE_SUBMIT,
...
echo $oFormBuilder->createForm([
	...
	'attr' => [
		'action' => '/',
		'target' => elements_ElementInterface::FORM_TARGET_SELF,
		'enctype' => elements_ElementInterface::ENCTYPE_MULTIPART,
		'method' => elements_ElementInterface::FORM_POST
	]
]);
?>
</body>

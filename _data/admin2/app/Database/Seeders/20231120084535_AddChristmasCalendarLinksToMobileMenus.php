...
class AddChristmasCalendarLinksToMobileMenus extends Seeder
{
    ...
    private string $mobile_page_path = '/mobile/christmas-calendar';
    private string $menu_name = '#mobile.menu.xmas';
    ...
    public function up()
    {
        $mobile_page = $this->getMobilePage();
        $mobile_menu = $this->getMobileMenu();
        $mobile_profile_menu = $this->getMobileProfileMenu();

        if (empty($mobile_page) || empty($mobile_menu) || empty($mobile_profile_menu)) {
            return;
        }
        ...
        $this->connection
            ...
            ->insert([
                [
                    ...
                    'name' => $this->menu_name,
                    'priority' => 204,
                    'link_page_id' => $mobile_page->page_id,
                    'link' => '',
                    'getvariables' => '',
                    'new_window' => 0,
                    'check_permission' => 0,

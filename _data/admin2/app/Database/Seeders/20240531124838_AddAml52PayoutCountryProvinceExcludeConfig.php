...
class AddAml52PayoutCountryProvinceExcludeConfig extends Seeder
{
    ...
    {
        $this->table = 'config';
        $this->configName = 'aml52-auto-payout-exclude-country-province';
        $this->configTag = 'AML';

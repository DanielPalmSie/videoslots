...
class AddPermissionForAddingAML60 extends Seeder
{
    ...
    public function init()
    {
        ...
        $this->permission_tags_items = [
            ['tag' => 'user.account.flag.manual.aml60', 'mod_desc' => '(automatically added)'],
        ];

        $this->table_permission_groups = 'permission_groups';

        $this->permission_group_items = [
            ['tag' => 'user.account.flag.manual.aml60', 'permission' => 'grant'],
        ];

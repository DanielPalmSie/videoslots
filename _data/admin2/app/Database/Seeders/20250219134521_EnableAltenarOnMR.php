...
/**
 * ./console seeder:up 20250219134521
 * ./console seeder:down 20250219134521
 */
class EnableAltenarOnMR extends Seeder
{
    ...
    public function up(): void
    {
        ...
        $this->connection->table($this->boxes)->where('page_id', '=', 868)->delete();

        /** Enable menus */
        $this->connection->table($this->menus)->whereIn('alias', [

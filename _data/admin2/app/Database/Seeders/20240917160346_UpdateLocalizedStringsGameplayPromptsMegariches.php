...
class UpdateLocalizedStringsGameplayPromptsMegariches extends Seeder
{
    ...
    protected array $data = [
        [
            ...
            'value' => '<h3 class="popup-title">Timeout-advarsel</h3>
        ...
        [
            'language' => 'dgoj',
            'alias' => 'lgatime.reached.html',
            'value' => '<h3 class="popup-title">Alerta de tiempo de espera</h3>
                        <p>El juego se ha interrumpido porque se ha alcanzado el límite de tiempo. <br /><br />
        ...
        [
            ...
            'value' => '<h3 class="popup-title">Indsatsgrænse nået</h3>
                        <p>Spillet er blevet afbrudt fordi din indsatsgr&aelig;nse er blevet n&aring;et.<br /><br />
                        Alle igangv&aelig;rende indsatser og gevinster vil blive gennemf&oslash;rt.<br /><br />
                        Hvis du var midt i en runde med free spins eller lignende vil disse genstarte n&aelig;ste gang du &aring;bner spillet.</p>',
        ...
        [
            'language' => 'dgoj',
            'alias' => 'lgawager.reached.html',
            'value' => '<h3 class="popup-title">Límite de apuesta alcanzado</h3>
                        <p>El juego se ha interrumpido porque se ha alcanzado el límite de apuesta. <br /><br />
                        Todas las apuestas y ganancias que se hayan iniciado se ejecutarán. <br /><br />
        ...
        [
            ...
            'value' => '<h3 class="popup-title">Grænse for maksimal indsatsbeskyttelse nået</h3>
                        <p>Spillet er blevet afbrudt, da du har placeret et v&aelig;ddem&aring;l eller spin ( inklusiv gambling funktionen ), der overstiger din maksimum beskyttelsgr&aelig;nse.<br /><br />
        ...
        [
            'language' => 'dgoj',
            'alias' => 'betmax.reached.html',
            'value' => '<h3 class="popup-title">Límite máximo de protección de la apuesta alcanzado</h3>
                        <p>El juego se ha interrumpido porque has realizado una apuesta o tirada (incluye función de juego) superior a tu límite de protección de apuesta máxima.<br /><br />
                        Si estabas en medio de una tirada gratuita o similar, volverás a entrar en la tirada gratuita la próxima vez que inicies el juego.</p>',
        ...
        [
            ...
            'value' => '<h3 class="popup-title">Tabsgrænse nået</h3>
                        <p>Spillet er blevet afbrudt, da du har n&aring;et din tabsgr&aelig;nse.<br /><br />
        ...
        [
            'language' => 'dgoj',
            'alias' => 'lgaloss.reached.html',
            'value' => '<h3 class="popup-title">Límite de pérdidas alcanzado</h3>
                        <p>El juego se ha interrumpido porque se ha alcanzado el límite de pérdidas.<br /><br />

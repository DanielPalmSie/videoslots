...
class AddRg77Content extends SeederTranslation
{
    protected array $data = [
        "en" => [
            "RG77.rg.info.description.html" => "You are one of {{top_depositors}} highest depositing customers " .
            ...
            "RG77.user.comment" => "RG77 Flag was triggered. User has risk of {{tag}}. User is one of the top {{top_depositors}} " .
                "highest depositing customer that have registered in the last {{months}} months. " .
                "An interaction via popup on login was made to inform customer that we noticed " .
                "he is a top {{top_depositors}} highest depositing customer that have registered " .

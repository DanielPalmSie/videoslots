...
class AddSportsbookToAdminJurisdiction extends Migration
{
    /** @var Connection */
    private $connection;
    ...
    public function down()
    {
        $this->connection
            ...
            ->update(
                [
                    'config_value' => '{"all":"","mt":"AND country = \'MT\'","mga":"AND country NOT IN (\'GB\', \'SE\', \'DK\')","se":"AND country = \'SE\'","dk":"AND country = \'DK\'","gb":"AND country = \'GB\'", "mga":"AND country NOT IN (\'GB\', \'SE\', \'DK\')"}'
                ]
            );
    }
}

...
if ( !$global_onlysetup ):
  ...
  <head>
    ...
    ?>
    <?php //$pager->includeCacheHole( __DIR__ . '/html/external_tracking_head.php' ) ?>
  </head>

  <?php if ( !empty( $landing_bkg ) ): ?>
      <body onload="<?php if ( $pager->edit_strings ) echo 'removeAllLinks()'; ?>" style="background: #000;">
  <?php else: ?>
      <body style="background-color: #000;" onload="<?php if ( $pager->edit_strings ) echo 'removeAllLinks()'; ?>">
  <?php endif ?>
  <?php //$pager->includeCacheHole( __DIR__ . '/html/external_tracking_body.php' ) ?>
    ...
    //$pager->includeCacheHole( __DIR__ . '/html/top_base_js.php' );

...
if ( !$global_onlysetup ):
  ...
  <body onload="<?php if ( $pager->edit_strings )
    echo 'removeAllLinks()'; ?>" style="background: #000;">
  <?php else: ?>
  <body style="background: #000;" onload="<?php if ( $pager->edit_strings )
    echo 'removeAllLinks()'; ?>">
  <?php endif ?>

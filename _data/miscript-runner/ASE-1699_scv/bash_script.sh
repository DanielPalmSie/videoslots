...
# DEVS-16318
command="artisan profile:re-link 4000025485 megariches 1967198182 videoslots"
echo "Executing command: ${command}"

sudo php ${command}

command="artisan profile:re-link 877703 mrvegas 1967198182 videoslots"
echo "Executing command: ${command}"

sudo php ${command}

# DEVS-16316
command="artisan profile:re-link 4000011110 megariches 1967042057 videoslots"
echo "Executing command: ${command}"

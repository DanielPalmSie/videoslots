...
csv_file_path=$( dirname -- "$( readlink -f -- "$0"; )"; )
command="artisan profile:remove-duplicates ${csv_file_path}/duplicate_profile_different_customer_phive_data.csv PHNX-4710"

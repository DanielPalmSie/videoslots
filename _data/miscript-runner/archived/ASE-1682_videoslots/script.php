...
phive('SQL')->query("INSERT INTO groups_members (group_id, user_id) VALUES (84, 1967007929)");

insertPermissionTagsCsv($sc_id, __DIR__ . "/permission_tags_to_be_added_VS.csv");
